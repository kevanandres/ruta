...
class DeliveryScreen extends StatefulWidget {
  final LatLng fromPoint = LatLng(-38.956176, -67.920666); //la magdalena
  final LatLng toPoint = LatLng(-38.953724, -67.923921); //tribuna del sur
...
class _DeliveryScreenState extends State<DeliveryScreen> {
  ...
  Set<Marker> _createMarkers() {
    ...
    tmp.add(Marker(
        ...
        infoWindow: InfoWindow(title: "Tribuna del Sur")));
    tmp.add(Marker(
        markerId: MarkerId("toPoint"),
        position: widget.toPoint,
        infoWindow: InfoWindow(title: "La Magdalena")));
    return tmp;
  }
